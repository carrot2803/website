                ...
                user.videoSources.forEach(videoSource => {
					...
					`;
                        ...
                        username.addEventListener('click', () => {
                            window.location.href = `./pages/UserProfile.html?username=${user.userName}`;
                        });

                        const gameName = userD.querySelector('.user p');
                        gameName.addEventListener('click', () => {
                            window.location.href = `./pages/Game-Video.html?gameName=${user.game[user.videoSources.indexOf(videoSource)]}`;
                        });
